...
HD_PWD='D:/VLSI-RTL/asic_design/xilinx/soc_cm3/soc_cm3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cortexm3_soc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cortexm3_soc.tcl
